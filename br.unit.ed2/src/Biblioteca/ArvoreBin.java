...
public class ArvoreBin<E extends Comparable<E>> implements Serializable {
    ...
    private class ArvoreIterator implements MyIterator<E> {
        ...
        private FilaEnc<NoArvoreBin<E>> fila = new FilaEnc<>();
        private NoArvoreBin<E> noAntetior;
        ...
        public E getFirst() {
            ...
            noAntetior = fila.remova();
            return noAntetior.getObj();
        }
    ...
    public NoArvoreBin<E> insert(E obj, NoArvoreBin<E> pai, int direcao) {
        ...
        NoArvoreBin<E> novoNo = new NoArvoreBin<>(obj, pai);
        if (pai == null) {
            raiz = novoNo;
            return novoNo;
        }
